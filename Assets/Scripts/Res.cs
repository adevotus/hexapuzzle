// dnSpy decompiler from Assembly-CSharp.dll class: Res
using System;
using UnityEngine;
...
public sealed class Res
{
    ...
    {
		//new Color(0.827451f, 0.3137255f, 0.345098048f),
		//new Color(0.9607843f, 0.6901961f, 0.215686277f),
		//new Color(0.192156866f, 0.6313726f, 0.8117647f),
		//new Color(0.5921569f, 0.7019608f, 0.270588249f),
		//new Color(0.6901961f, 0.466666669f, 0.392156869f),
		//new Color(0.458823532f, 0.768627465f, 0.6862745f),
		//new Color(0.470588237f, 0.392156869f, 0.6745098f),
		//new Color(0.7764706f, 0.129411772f, 0.152941182f),
		//new Color(0.9647059f, 0.5568628f, 0.184313729f),
        new Color(1, 61/255f, 172/255f),
        new Color(245/255f, 193/255f, 55/255f),
